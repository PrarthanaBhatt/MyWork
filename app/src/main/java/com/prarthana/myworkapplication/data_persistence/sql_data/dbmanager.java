...
public class dbmanager  extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String qry="create table tbl_contact ( id integer primary key autoincrement, name text, contact text, email text,address text)";
    ...
    public  String addrecord(String name, String contact, String email,String address)
    {
